    ...
    try:
        ...
        try:
            if cur_floor == 1:
                ...
                #pdb.set_trace()
                sql = '%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s'%('insert into main_post(post_id,post_title,post_view,post_reply,post_date,post_content,auth_id,auth_name,auth_join_date,auth_post_num,auth_topic_num,auth_time,auth_level,auth_value,auth_money,auth_reputation)values(',str(tid),',"',title,'","',view,'","',reply,'","',date,'","',content,'",',str(auth_id),',"',auth_list[0],'","',auth_list[4],'","',auth_list[7],'","',auth_list[8],'","',auth_list[1],'","',auth_list[3],'","',auth_list[2],'","',auth_list[6],'","',auth_list[5],'");')
            else:
                if cur_floor > 0:
                    sql = '%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s'%('insert into post_detail(post_id,post_floor,post_date,post_content,auth_id,auth_name,auth_join_date,auth_post_num,auth_topic_num,auth_time,auth_level,auth_value,auth_money,auth_reputation)values(',str(tid),',',str(cur_floor),',"',date,'","',content,'",',str(auth_id),',"',auth_list[0],'","',auth_list[4],'","',auth_list[7],'","',auth_list[8],'","',auth_list[1],'","',auth_list[3],'","',auth_list[2],'","',auth_list[6],'","',auth_list[5],'");')
                else:
                    sql = '%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s'%('insert into another_post_detail(post_id,post_floor,post_date,post_content,auth_id,auth_name,auth_join_date,auth_post_num,auth_topic_num,auth_time,auth_level,auth_value,auth_money,auth_reputation)values(',str(tid),',',str(crawler.floor),',"',date,'","',content,'",',str(auth_id),',"',auth_list[0],'","',auth_list[4],'","',auth_list[7],'","',auth_list[8],'","',auth_list[1],'","',auth_list[3],'","',auth_list[2],'","',auth_list[6],'","',auth_list[5],'");')
        except:
           print auth_list
        lock.acquire()
        crawler.insert(sql)
